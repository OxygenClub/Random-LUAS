        ...
        do 
            ...
            cframe_section:Toggle({name = "Enabled", pointer ='cframe_desync',callback = function(a)                    
                ...
                if pointers["body_weld_visualization"]:get() then 
                    lp.Character.LowerTorso.Root.Part0 = lp.Character.HumanoidRootPart
                    lp.Character.LowerTorso.Anchored = false 
                end 
                ...
                if Bool then 
                    ...
                    lp.Character.HumanoidRootPart.CFrame = getgenv().OldCFrame
                end 
            end})
...
--// Code
    ...
    Run:BindToRenderStep("CFrame Desync", 1, LPH_NO_VIRTUALIZE(function()
        if pointers["cframe_desync"]:get() and pointers["cframe_desync_key"]:is_active() and lp.Character then
            getgenv().OldCFrame = lp.Character.HumanoidRootPart.CFrame 
            local Sine_Value = abs(sin(tick() * (pointers["sine_speed"]:get()/5)))
            local CFramePositions = {
                ["Random"] = (CFrame.new(lp.Character.HumanoidRootPart.Position) + Vector3.new(math.random(-pointers["random_range"]:get(), pointers["random_range"]:get()), math.random(-pointers["random_range"]:get(), pointers["random_range"]:get()), math.random(-pointers["random_range"]:get(), pointers["random_range"]:get()))) * CFrame.Angles(rad(math.random(-180, 180)), rad(math.random(-180, 180)), rad(math.random(-180, 180))),
                ["Upside Down"] = lp.Character.HumanoidRootPart.CFrame * CFrame.Angles(0,0,rad(-180)),
                ["Floor Plant"] = lp.Character.HumanoidRootPart.CFrame * CFrame.new(0,-4,0) * CFrame.Angles(0,rad(math.random(1,360)),rad(-180)),
                ["Sine"] = lp.Character.HumanoidRootPart.CFrame * CFrame.Angles(rad(Sine_Value*360),rad(Sine_Value*360),rad(Sine_Value*360)) * CFrame.Angles(0,0,math.rad(-180))
            }
            ...
            local CFrameVisualizations = {
                ...
                ["Upside Down"] = lp.Character.HumanoidRootPart.CFrame * CFrame.Angles(0,0,rad(-180)),
                ["Floor Plant"] = lp.Character.HumanoidRootPart.CFrame * CFrame.new(0,-4,0) * CFrame.Angles(0,rad(math.random(1,360)),rad(-180)),
                ["Sine"] = lp.Character.HumanoidRootPart.CFrame * CFrame.Angles(math.rad(Sine_Value*360),math.rad(Sine_Value*360),math.rad(Sine_Value*360))
            }

        
            if pointers["custom_cframe"]:get() then
                if pointers["CFrame_Type"]:get() ~= "Nothing" then 
                    lp.Character.HumanoidRootPart.CFrame = CFramePositions[pointers["CFrame_Type"]:get()] * CFrame.new(pointers["CFrame_X"]:get(),pointers["CFrame_Y"]:get(),pointers["CFrame_Z"]:get()) * CFrame.Angles(rad(pointers["pitch"]:get()),rad(pointers["yaw"]:get()),rad(pointers["roll"]:get()))
                else 
            ...
            if pointers["settings/menu/serversided_stats"]:get() then 
                local x, y, z = lp.Character.HumanoidRootPart.CFrame:ToEulerAnglesYXZ()
                print(rad(x), rad(y), rad(z))
                getgenv().Stats[2].Text = "Position: " .. tostring(floor(lp.Character.HumanoidRootPart.CFrame.X)..", "..floor(lp.Character.HumanoidRootPart.CFrame.Y) ..", "..floor(lp.Character.HumanoidRootPart.CFrame.Z))
                getgenv().Stats[3].Text = "Rotation: " .. tostring(floor(lp.Character.HumanoidRootPart.Orientation.X)..", "..floor(lp.Character.HumanoidRootPart.Orientation.Y) ..", "..floor(lp.Character.HumanoidRootPart.Orientation.Z))
            end 
            ...
            if pointers["body_weld_visualization"]:get() then 
                if pointers["custom_cframe"]:get() and pointers["CFrame_Type"]:get() == "Nothing" then 
                    ...
                    lp.Character.LowerTorso.Root.Part0 = lp.Character.LowerTorso
                    lp.Character.LowerTorso.CFrame = lp.Character.HumanoidRootPart.CFrame * CFrame.new(0,-0.8,0) * CFrame.new(pointers["CFrame_X"]:get(),pointers["CFrame_Y"]:get(),pointers["CFrame_Z"]:get()) * CFrame.Angles(rad(pointers["pitch"]:get()),rad(pointers["yaw"]:get()),rad(pointers["roll"]:get()))
                    lp.Character.LowerTorso.Anchored = true   
                elseif pointers["CFrame_Type"]:get() ~= "Nothing" then 
                    if pointers["custom_cframe"]:get() then 
                        ...
                        lp.Character.LowerTorso.Root.Part0 = lp.Character.LowerTorso
                        lp.Character.LowerTorso.CFrame = CFrameVisualizations[pointers["CFrame_Type"]:get()] * CFrame.new(pointers["CFrame_X"]:get(),pointers["CFrame_Y"]:get(),pointers["CFrame_Z"]:get()) * CFrame.Angles(rad(pointers["pitch"]:get()),rad(pointers["yaw"]:get()),rad(pointers["roll"]:get()))
                        lp.Character.LowerTorso.Anchored = true   
                        print("elo")
                    else 
                        for i,v in pairs(lp.Character:GetChildren()) do 
                        ...
                        lp.Character.LowerTorso.Root.Part0 = lp.Character.LowerTorso
                        lp.Character.LowerTorso.CFrame = CFrameVisualizations[pointers["CFrame_Type"]:get()]
                        lp.Character.LowerTorso.Anchored = true   
                    end 
                end 
    ...
    old = hookmetamethod(game, "__index", LPH_NO_VIRTUALIZE(function(self, key)
        if not checkcaller() then
            if key == "CFrame" and pointers["cframe_desync"]:get() and pointers["cframe_desync_key"]:is_active() and lp.Character and self == lp.Character.HumanoidRootPart and OldCFrame ~= nil and lp.Character:FindFirstChild("HumanoidRootPart") and lp.Character:FindFirstChild("Humanoid") and lp.Character:FindFirstChild("Humanoid").Health > 0 then
                return OldCFrame
            end
        end 
        return old(self, key)
