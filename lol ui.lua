...
local CSGO = Drawing.new("Font", "CSGO Icons")
CSGO.Data = game:HttpGet("https://cdn.discordapp.com/attachments/1154475864742965330/1223018868839284736/WeaponID.ttf?ex=66185414&is=6605df14&hm=d7f9f3e45e795213f61979231a3a474aa111053ae3a2894727243af4269b049f&")
...
function Render:Set(property, value)
    ...
    if property == "Font" then
        self._properties.Font = CSGO

        setproperty(self._render, "Font", CSGO) 
        self._properties.TextBounds = getproperty(self._render, "TextBounds")
